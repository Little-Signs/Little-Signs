...
class UserAdmin(BaseUserAdmin, ModelAdmin):
    ...
    list_display = ('email', 'first_name', 'last_name', 'is_staff', 'is_active', 'is_organisation', 'is_individual')
    list_filter = ('is_staff', 'is_active', 'is_organisation', 'is_individual')
    fieldsets = (
        (None, {'fields': ('email', 'password')}),
        ('Personal info', {'fields': ('first_name', 'last_name', 'phone_number', 'gender', 'date_of_birth', 'city')}),
